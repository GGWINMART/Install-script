...
echo 'echo -e "\e[94m    #+#    #+# #+#    #+# #+#    #+#    #+#       "' >> .bashrc
echo 'echo -e "\e[94m    #########  ###    ###  ########     ###       "' >> .bashrc
echo 'echo -e "\e[94m           Modified by Enternet Digital           "' >> .bashrc
echo 'echo -e "\e[0m"'                                                    >> .bashrc
...
echo "<h1><center>Modified by Enternet Digital</center></h1>" > /home/vps/public_html/index.html
echo "<h3><center>For More Info Visit <a href="https://vps.enternet.digital">Enternet Digital</a></center><h3>" >> /home/vps/public_html/index.html
...
echo -e "\e[94m[][][]======================================[][][]"
echo -e "\e[0m                                                   "
echo -e "\e[94m           Modified by Enternet Digital           "
echo -e "\e[94m                                                  "
